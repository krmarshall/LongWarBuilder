...
const GridsContainer = (): JSX.Element => {
  ...
  return (
    <div className="m-4 mt-1.5 p-2 bg-darkGray opacity-100 rounded flex-auto flex-wrap flex-grow justify-center overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-scrollbarGray shadow-lg select-none">
