...
const PerkGrid = (): JSX.Element => {
  ...
  return (
    <div
      className="m-4 p-2 bg-darkGray rounded opacity-100 flex flex-wrap flex-grow justify-center overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-300 shadow-lg"
